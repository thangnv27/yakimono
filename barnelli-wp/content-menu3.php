	...
	<div id="third-menu" class="barnelli-menu padding-wrapper">
		<div class="container animate-in animate-in-fade">
			...
			<section class="row">
				...
				?>
				<div class="menu-list col-sm-6 col-md-<?php echo $gridMod; ?>">
					<article class="menu-item">
						...
						$image = ($dish_img[0]) ? $dish_img[0] : '';
						?>
						<figure><img src="<?php echo $image; ?>" alt=""/></figure>
						<p class="title" style="color: <?php echo $titleFontColor ?>"><?php echo $menuTitle; if ( $menuSecondTitle != '' ) : ?> <span>(<?php echo $menuSecondTitle; ?>)</span><?php endif; ?></p>
