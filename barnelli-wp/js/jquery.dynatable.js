        ...
        if (settings.params.hasOwnProperty(attr)) {
          ...
          if (
            (!settings.features.sort && attr == "sorts") ||
              (!settings.features.paginate && _this.anyMatch(attr, ["dynapage", "perPage", "offset"], function(attr, param) { return attr == param; }))
          ) {
            continue;
          }

          // Delete page and offset from url params if on page 1 (default)
          if ((attr === "dynapage" || attr === "offset") && data["dynapage"] === 1) {
            if (urlOptions[label]) {
