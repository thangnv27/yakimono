...
<div class="dynamic-content <?php echo $wrapperClass; ?>-wrapper menu-wrapper" id="main-content" data-menu-type="<?php echo $barnelli_menu_type;?>">
	...
	<?php
	$menuStyle = YSettings::g('dynamic_'.$barnelli_menu_type.'_menu_style', '') == 'no-bullets' ? 'no-bullets' : '';

	$foodMenuSidebar = 'dynamic_'.$barnelli_menu_type .'_sidebar';
	$foodMenuSidebarPosition = YSettings::g($foodMenuSidebar, 'none');
	?>
	<div class="barnelli-menu padding-wrapper <?php echo $menuStyle ?>">
		<div class="slidee">
			<div class="container animate-in animate-in-fade">
				...
				<section class="row">
					...
					<div class="col-md-10 col-md-offset-1">
						<dl>
							<dt>
								<h2 style="color: <?php echo $categoryFontColor; ?> !important; font-size: <?php echo $categoryFontSize; ?>px !important;"><?php echo $category->name; ?> <?php echo $icon; ?></i></h2>
								<?php if ($category->description != '') : ?>
									<div class="menu-description menu-description-list" ><p style="color: <?php echo $categoryDescriptionFontColor; ?> !important; font-size: <?php echo $categoryDescriptionFontSize; ?>px !important;"><?php echo $category->description; ?></p></div>
								<?php endif;?>
							</dt>
							<?php
							...
							?>
								<dd class="menu-list">
									<section class="menu-item">
										<p class="title" style="color: <?php echo $titleFontColor; ?>; font-size: <?php echo $titleFontSize; ?>px !important;">
											<?php echo $menuTitle; ?>
											<?php if ($menuSecondTitle != ''): ?> (<?php echo $menuSecondTitle; ?>)<?php endif; ?>
										</p>
										<div class="description" style="color: <?php echo $descriptionColor; ?>; font-size: <?php echo $descriptionSize; ?>px !important;"><?php echo do_shortcode($menuSubitle); ?></div>
									</section>
									<section class="price" style="color: <?php echo $priceColor; ?>;font-size: <?php echo $priceSize; ?>px !important;">
										<?php
