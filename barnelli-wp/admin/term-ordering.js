...
jQuery(document).ready(function($) {
	...
	$("table.widefat.wp-list-table").sortable({
		...
		update: function(event, ui) {
			...
			$.post(ajaxurl, {action: 'barnelli-term-ordering', id: termid, nextid: nexttermid, thetaxonomy: barnelli_term_ordering_params.taxonomy }, function(response) {
