	...
	jQuery(document).ready(function() {
		if (jQuery('#restaurant_grid_indexes_id').length) {
			...
			if (gridArray.length == 2) {
				jQuery('#EightButton').attr('disabled', true);
			} else if (gridArray.length == 3) {
			...
			jQuery("a.editBlock").live("click", function(e) {
				...
				var functionValueDuration = jQuery('#theme_grid_function_value_duration_'+currentIndex+'_id').val();
				...
				if (functionType == 'custom_code') {
					...
					jQuery('#theme_grid_events_slide_duration').val( jQuery('#theme_grid_function_value_duration_'+currentIndex+'_id').val() );
					...
					jQuery('#theme_grid_slider_category_slide_duration').val( jQuery('#theme_grid_function_value_duration_'+currentIndex+'_id').val() );
				}
			...
			jQuery( "#save-edit-item").live( "click", function(e) {
				...
				var editedFunctionValueDuration = '';
				...
				if (editedFunction == 'slider_category') {
					...
					editedFunctionValueDuration = jQuery('#theme_grid_slider_category_slide_duration').val();
				}
				...
				if (editedFunction == 'events') {
					...
					editedFunctionValueDuration = jQuery('#theme_grid_events_slide_duration').val();
				}
				...
				if (jQuery('#theme_grid_name_' + currentIndex + '_id').length) {
					...
					jQuery('#theme_grid_function_value_duration_'+currentIndex+'_id').val(editedFunctionValueDuration);
					...
					var newElement = jQuery('<div id="element-'+currentIndex+'">'+
						...
						'<input id="theme_grid_function_value_duration_'+currentIndex+'_id" type="hidden" name="yopress[grid_function_value_duration_'+currentIndex+']" value=""/>'+
				...
				jQuery('#theme_grid_function_value_duration').val('');
				jQuery('#theme_grid_title').val('');
				jQuery('#theme_grid_subtitle').val('');
				jQuery('#theme_grid_title_hover').val('');
				jQuery('#theme_grid_subtitle_hover').val('');
			...
			jQuery("#EightButton").live( "click", function(e) {
			...
			jQuery("#TwelveButton").live( "click", function(e) {
				if (confirm('This action will remove bottom rows. Are You sure ?')) {
					...
					jQuery('#EightButton').attr('disabled', false);
					jQuery('#TwentyButton').attr('disabled', false);
					jQuery('#SixTeenButton').attr('disabled', false);
					jQuery('#TwelveButton').attr('disabled', true);
				}
