...
<form class="shipping_calculator " action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
	...
	<h4><a href="#" data-djax-exclude="true" class="shipping-calculator-button"><?php _e( 'Calculate Shipping', 'woocommerce' ); ?> <i class="fa fa-caret-down pull-right"></i></a></h4>
	...
	<section class="shipping-calculator-form">
		...
		<p class="clearfix"><button type="submit" name="calc_shipping" value="1" class="button wc-button pull-right"><?php _e( 'Update Totals', 'woocommerce' ); ?></button></p>
