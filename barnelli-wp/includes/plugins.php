...
require_once( THEME_INCLUDES . '/plugin-class-tgmpa.php' );
 ...
 * @since 1.0
 */
function barnelli_register_required_plugins() {
...
/* Register the required plugins for this theme. */
add_action( 'tgmpa_register', 'barnelli_register_required_plugins' );
?>