<ul class="unstyled"> 
	<li><i style="font-size:10px;width:100px !important;" class="no-icon"><?php _e('empty', THEME_NAME); ?></i></li>
	...
	<li><i class="fa fa-pied-piper-square"></i></li>
